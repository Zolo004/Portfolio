...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center bg-gradient-to-br from-white to-blue-50"
    >
      {/* Background Elements */}
      ...
      <div className="section-container relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 animate-fade-in [animation-delay:1200ms] opacity-0">
            <Button
              asChild
              className="bg-portfolio-blue hover:bg-portfolio-darkBlue text-white px-8 py-6"
            >
            ...
            <Button
              asChild
              variant="outline"
              className="border-portfolio-purple text-portfolio-purple hover:bg-portfolio-purple/10 px-8 py-6"
            >
